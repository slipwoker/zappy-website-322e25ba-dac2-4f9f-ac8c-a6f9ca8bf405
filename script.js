    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Moshe Shtaegman uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '322e25ba-dac2-4f9f-ac8c-a6f9ca8bf405',
                    name: data.name || '',
                    email: data.email || '',
